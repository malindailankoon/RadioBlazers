...
class base_to_user_flowgraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, ConFile='default', MsgFile='default', RnFile='default'):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\immkb\\Desktop\\semester_3\\communication_design_project\\pickaxe\\rec_side_stuff\\misc\\output.tmp', False)
