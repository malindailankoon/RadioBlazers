...
mp = subprocess.Popen(["C:/Users/immkb/radioconda/python.exe", path_to_malinda_script, "--MsgFile=misc/message.txt", "--ConFile=userTObase/rec_side_stuff/misc/confirm.txt", "--RnFile=userTObase/rec_side_stuff/misc/request.txt"])
