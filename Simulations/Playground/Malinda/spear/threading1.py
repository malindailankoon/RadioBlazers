...
class threading1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "threading1")
        ...
        self.freq2 = freq2 = 5.8e9
        self.freq1 = freq1 = 1.2e9
        ...
        self.soapy_bladerf_source_0.set_bandwidth(0, 10E3)
        self.soapy_bladerf_source_0.set_frequency(0, freq1)
        ...
        self.soapy_bladerf_sink_0.set_bandwidth(0, 10e3)
        self.soapy_bladerf_sink_0.set_frequency(0, freq1)
        self.soapy_bladerf_sink_0.set_frequency_correction(0, 0)
        self.soapy_bladerf_sink_0.set_gain(0, min(max(50.0, 17.0), 73.0))
        ...
        self.epy_block_0 = epy_block_0.blk(node_id=1, aloha_prob=0.6, timeout=0.2, max_retries=100)
        ...
        self.connect((self.digital_constellation_modulator_0_0, 0), (self.qtgui_const_sink_x_1, 0))
        self.connect((self.digital_constellation_modulator_0_0, 0), (self.qtgui_freq_sink_x_1, 0))
        ...
        self.connect((self.digital_linear_equalizer_0, 0), (self.digital_costas_loop_cc_0_1_0, 0))
        ...
        self.connect((self.soapy_bladerf_source_0, 0), (self.qtgui_const_sink_x_0, 0))
    ...
    def set_freq1(self, freq1):
        self.freq1 = freq1
        self.soapy_bladerf_sink_0.set_frequency(0, self.freq1)
        self.soapy_bladerf_source_0.set_frequency(0, self.freq1)
