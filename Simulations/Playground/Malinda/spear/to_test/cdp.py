...
import cdp_epy_block_0_0 as epy_block_0_0  # embedded python block
import cdp_epy_block_0_0_0 as epy_block_0_0_0  # embedded python block
...
class cdp(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500):
        ...
        self.epy_block_0_0_0 = epy_block_0_0_0.blk(node_id=2, aloha_prob=0.6, timeout=0.2, max_retries=100)
        ...
        self.digital_linear_equalizer_0_0_0_0 = digital.linear_equalizer(15, 4, variable_adaptive_algorithm_0, True, [ ], 'corr_est')
        ...
        self.blocks_throttle2_0_0 = blocks.throttle( gr.sizeof_gr_complex*1, 48000, True, 0 if "auto" == "auto" else max( int(float(0.1) * 48000) if "auto" == "time" else int(0.1), 1) )
        ...
        self.msg_connect((self.epy_block_0_0_0, 'pdu_out'), (self.digital_protocol_formatter_async_0_0, 'in'))
        self.msg_connect((self.epy_block_0_0_0, 'msg_out'), (self.epy_block_0_1_0, 'in_msg'))
        self.msg_connect((self.epy_block_0_0_0, 'feedback'), (self.epy_block_0_1_0, 'feedback'))
        self.msg_connect((self.epy_block_0_1, 'out'), (self.epy_block_0_0, 'msg_in'))
        self.msg_connect((self.epy_block_0_1_0, 'out'), (self.epy_block_0_0_0, 'msg_in'))
        self.msg_connect((self.pdu_tagged_stream_to_pdu_0_0, 'pdus'), (self.epy_block_0_0, 'pdu_in'))
        self.msg_connect((self.pdu_tagged_stream_to_pdu_0_0_0, 'pdus'), (self.epy_block_0_0_0, 'pdu_in'))
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0, 0), (self.digital_correlate_access_code_xx_ts_0_0_0, 0))
        ...
        self.connect((self.channels_channel_model_0, 0), (self.qtgui_freq_sink_x_1_0_0, 0))
        ...
        self.connect((self.digital_correlate_access_code_xx_ts_0_0_0, 0), (self.blocks_repack_bits_bb_1_0_0, 0))
        ...
        self.connect((self.digital_linear_equalizer_0_0_0_0, 0), (self.digital_costas_loop_cc_0_0_0, 0))
        ...
        self.connect((self.digital_symbol_sync_xx_0_0_0, 0), (self.digital_linear_equalizer_0_0_0_0, 0))
