...
class testing(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default'):
        ...
        self.connect((self.channels_channel_model_0, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.channels_channel_model_1, 0), (self.digital_symbol_sync_xx_0, 0))
        ...
        self.connect((self.digital_fll_band_edge_cc_0, 0), (self.channels_channel_model_1, 0))
