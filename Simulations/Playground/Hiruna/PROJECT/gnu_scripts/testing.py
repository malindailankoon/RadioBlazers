...
class testing(gr.top_block):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "testing stuff", catch_exceptions=True)
        ...
        self.blocks_repack_bits_bb_1 = blocks.repack_bits_bb(8, 1, "", False, gr.GR_LSB_FIRST)
        self.blocks_repack_bits_bb_0 = blocks.repack_bits_bb(1, 8, "", False, gr.GR_MSB_FIRST)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\immkb\\Desktop\\semester_3\\communication_design_project\\PROJECT\\to_be_transmitted\\message.txt', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\immkb\\Desktop\\semester_3\\communication_design_project\\PROJECT\\dummy_receiving\\receive.txt', False)
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.blocks_repack_bits_bb_1, 0))
